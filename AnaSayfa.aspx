<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AnaSayfa.aspx.cs" Inherits="AET_RDA_WEBREPORT2.AnaSayfa" %>
...
<body>
    ...
    <form runat="server">
         <br />  
        <dx:ASPxButton ID="ASPxButton1" runat="server" Text="2022 Raporları için Tıklayınız..." Height="100px" Width="200px" Font-Size="Medium" Font-Bold="true" OnClick="ASPxButton1_Click"></dx:ASPxButton>
        ...
        <table style="width: 100%;">
            ...
            <thead>
                <tr>
                    <th>
                        <br />
                        <h1 style="color:white; background-color:red" > AET 2021 SATIŞ RAPORU</h1>
                    </th>
            ...
            <tr>
                <td>
                    <br />
                    <dx:ASPxPivotGrid ID="SATISRAPORPIVOT" runat="server" OptionsData-DataProcessingEngine="Optimized" ClientIDMode="AutoID"
                        DataSourceID="AETRAPOR" IsMaterialDesign="False">
                    ...
                    <asp:SqlDataSource ID="AETRAPOR" runat="server"
                        ConnectionString="<%$ ConnectionStrings:AET  %>"
                        SelectCommand="SELECT * FROM [_VW_WEB_SATIS_RAPOR]"></asp:SqlDataSource>
                </td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
            </tr>
